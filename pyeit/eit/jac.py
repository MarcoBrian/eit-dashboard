...
class JAC(EitBase):
    ...
    def gn(self, v, x0=None, maxiter=1, gtol=1e-4, p=None, lamb=None,
           lamb_decay=1.0, lamb_min=0, method='kotre', verbose=False, converge_info=False):
        """
        ...
        converge_info: bool, optional
            if true returns convergence array, default value false
